...
namespace Panthera.Skills.Actives
{
    class ClawsStorm : MachineScript
    {
        ...
        public override void FixedUpdate()
        {
            ...
            if (base.characterBody.fury < PantheraConfig.ClawsStorm_continuousConsumedFury || this.wasInterrupted == true || base.inputBank.keysPressedList.HasFlag(KeysBinder.KeysEnum.Skill2) == false)
            {
                base.EndScript();
            }
