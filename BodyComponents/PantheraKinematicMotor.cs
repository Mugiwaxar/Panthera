...
namespace Panthera.BodyComponents
{
    ...
    public class PantheraKinematicMotor : KinematicCharacterMotor
    {
        ...
        public void DoInit()
        {
            pantheraMotor = GetComponent<PantheraMotor>();
        }
                ...
                for (; i < 3; i++)
                {
                    ...
                    if (num > 0)
                    {
                        for (int j = 0; j < num; j++)
                        {
                            ...
                            {
                                HitStabilityReport hitStabilityReport = default;
                            ...
                            for (int j = 0; j < num2; j++)
                            {
                                ...
                                if (InteractiveRigidbodyHandling)
                                {
                                    ...
                                    if ((bool)attachedRigidbody)
                                    {
                                        ...
                                        {
                                            HitStabilityReport hitStabilityReport2 = default;
