...
namespace Panthera.BodyComponents
{
    public class PantheraHealthComponent : HealthComponent
    {
        ...
        public static void TakeDamageHook(Action<HealthComponent, DamageInfo> orig, HealthComponent self, DamageInfo damageInfo)
        {
            ...
            int extendedProtectionLevel = hc.ptraObj.profileComponent.getAbilityLevel(PantheraConfig.ExtendedProtection_AbilityID);
            ...
            if (hc.ptraObj.guardianMode == true && hc.ptraObj.profileComponent.isMastery(PantheraConfig.SavageRevitalization_AbilityID) == true)
            {
            ...
            if (hc.ptraObj.guardianMode == true && hc.ptraObj.profileComponent.getAbilityLevel(PantheraConfig.Furrify_AbilityID) > 0)
            {
            ...
            int enchantedFurLevel = hc.ptraObj.profileComponent.getAbilityLevel(PantheraConfig.EnchantedFur_AbilityID);
            ...
            int tornadoLevel = hc.ptraObj.profileComponent.getAbilityLevel(PantheraConfig.Tornado_AbilityID);
            ...
            int protectionLevel = hc.ptraObj.profileComponent.getAbilityLevel(PantheraConfig.InnateProtection_AbilityID);
