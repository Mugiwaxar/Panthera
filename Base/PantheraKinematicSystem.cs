...
namespace Panthera.Base
{
    public class PantheraKinematicSystem : KinematicCharacterSystem
    {
        ...
        //        CharacterMotors[l].AttachedRigidbody.position = CharacterMotors[l].TransientPosition;
        //        CharacterMotors[l].AttachedRigidbody.rotation = CharacterMotors[l].TransientRotation;
        //    }
        //}
        ...
        //        motors[l].AttachedRigidbody.position = motors[l].TransientPosition;
        //        motors[l].AttachedRigidbody.rotation = motors[l].TransientRotation;
        //    }
        //}
