    ...
    class FrontRip : MachineScript
    {
        ...
        public override void FixedUpdate()
        {
            ...
            if (hasFired == false)
            {
                ...
                Functions.SpawnEffect(gameObject, Assets.FrontRipFX, characterBody.corePosition, 1, modelTransform.gameObject, Util.QuaternionSafeLookRotation(characterDirection.forward));
