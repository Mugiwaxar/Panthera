...
namespace Panthera.Components
{
    public class XRayComponent : MonoBehaviour
    {
        ...
        public void FixedUpdate()
        {
            ...
            if (this.ptraObj.profileComponent.getAbilityLevel(PantheraConfig.Concentration_AbilityID) > 0)
            {
                ...
                // Update Colors //
                if (this.ptraObj.detectionMode == true && this.ptraObj.profileComponent.getAbilityLevel(PantheraConfig.SixthSense_AbilityID) > 0)
                {
