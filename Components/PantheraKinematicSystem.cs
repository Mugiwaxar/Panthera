...
namespace Panthera.Components
{
    internal class PantheraKinematicSystem : KinematicCharacterSystem
	{
		...
		public static void Simulate(On.KinematicCharacterController.KinematicCharacterSystem.orig_Simulate_float orig, float deltaTime)
		{
		...
		public static void Simulate(On.KinematicCharacterController.KinematicCharacterSystem.orig_Simulate_float_KinematicCharacterMotorArray_int_PhysicsMoverArray_int orig,
									float deltaTime, KinematicCharacterMotor[] motors, int characterMotorsCount, PhysicsMover[] movers, int physicsMoversCount)
		{
