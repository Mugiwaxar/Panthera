...
namespace HotCompilerNamespace
{
    internal class HotCompiler
    {
        ...
        {
            const string pathToHotReloadMain = "C:/Users/User/Bureau/ROR2/PantheraMod/vscode/HotCompilerNamespace/HotReloadMain.cs";
            ...
            if (ass == null)
            {
                Debug.LogError($"Failed hot compiling assembly");
                return;
            }
           ...
           .FirstOrDefault(m => m.Name == nameof(HotReloadMain.HotReloadEntryPoint));
            ...
            if (entryPoint == null)
            {
                Debug.LogError($"Failed getting entrypoint");
                return;
            }

            var res = entryPoint.Invoke(null, null);

            Debug.LogWarning($"CompilationCount: {CompilationCount++}");
        }
