...
namespace Panthera.MachineScripts
{
    public class BigCatPassive : MachineScript
    {
        ...
        public override void Update()
        {
            ...
            // Add Shield //
            if (base.pantheraObj.profileComponent.getAbilityLevel(PantheraConfig.Guardian_AbilityID) > 0 && base.pantheraObj.frontShieldDeployed == false)
            {
                ...
                int improvedShieldAbilityLevel = base.pantheraObj.profileComponent.getAbilityLevel(PantheraConfig.ImprovedShield_AbilityID);
        ...
        public override void FixedUpdate()
        {
            ...
            if (unsleepAsked == true)
            {
                if (Time.time - this.unsleepTime > PantheraConfig.unsleepDuration)
                {
                    ...
                    if (base.pantheraObj.profileComponent.getAbilityLevel(PantheraConfig.GoldenStart_AbilityID) > 0)
        ...
        public void OnDamageReceived(DamageDealtMessage damageDealtMessage)
        {
            ...
            int innerRageLvl = base.pantheraObj.profileComponent.getAbilityLevel(PantheraConfig.InnerRage_AbilityID);
            if (innerRageLvl == 1)
            ...
            if (base.pantheraObj.profileComponent.isMastery(PantheraConfig.InnerRage_AbilityID))
            {
