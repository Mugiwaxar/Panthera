        ...
        public override void FixedUpdate()
        {
            ...
            if (NetworkClient.active == true)
            {
                ...
                if ((Time.time - this.onGroundTime) > PantheraConfig.Death_effectStartTime && this.deathEffectID == 0)
                {
                    ...
                    this.deathEffectID = Utils.FXManager.SpawnEffect(base.gameObject, Base.PantheraAssets.DeadFX, position, base.pantheraObj.actualModelScale, base.characterBody.gameObject, new Quaternion(), true);
                    CamHelper.ApplyCameraType(CamHelper.AimType.Death, base.pantheraObj);
                }
            }
